...
while MS involves **internal, non-observable** psychological states (了解, 怀疑, 尊重).
        ...
        "key_characteristics": [
            ...
            "Discourse verbs: Verbs of speaking, writing, analysing, commenting",
    ...
    "DISP": {
        "name_en": "Disposition",
        "name_zh": "态度处置构式",
        "short_description": "X exhibits behavioural manner toward Y",
        "full_description": """
**Disposition (DISP)** is a construction where X exhibits a characteristic **behavioural manner 
...
"对Y怎么样?" (How does X treat Y?). Common predicates include 好, 客气, 热情, 冷淡.
        """,
        "dui_meaning": "toward (BEHAVIOURAL/SOCIAL ORIENTATION)",
        "dui_function": "Marks Y as the target of X's behavioural manner",
        "key_characteristics": [
            "Behavioural (行为态度): Observable manner of interaction",
        ...
        "typical_patterns": [
            ("Warm manner", "对Y 热情/热心/亲切/友善", "Warm behavioural manner"),
            ("Cold manner", "对Y 冷淡/冷漠/疏远", "Cold behavioural manner"),
        ...
        "semantic_roles": {
            ...
            "dowty": {
                "X": {
                    "proto_agent": ["✓ Volitional", "✓ Controls behaviour", "✓ Can be praised/blamed"],
                    "proto_patient": []
                },
                "Y": {
                    "proto_agent": [],
        ...
        "example_sentences": [
            ...
            {"zh": "老板对员工很好。", "en": "The boss treats employees well.", "analysis": "好 describes X's behavioural manner toward Y"}
        ],
        "color": "#E91E63"
    },
...
MS_VS_DISP_DISTINCTION = {
    "title": "MS vs DISP: Internal State vs Observable Manner",
    "key_question": "Can you SEE it, or is it IN X's mind?",
    "comparison": [
        {
            "feature": "Observable?",
            "MS": "No (internal state)",
            "DISP": "Yes (external behaviour)"
        },
        {
            "feature": "Focus",
            "MS": "What X thinks/feels",
            "DISP": "How X behaves/treats Y"
        },
        {
            "feature": "Y's role",
            "MS": "Stimulus that triggers state",
            "DISP": "Target of behavioural manner"
        },
        {
            "feature": "Verb type",
            "MS": "Psychological state verbs",
            "DISP": "Stative manner predicates"
        },
        {
            "feature": "Key test",
            "MS": "Does Y trigger a feeling/thought IN X?",
            "DISP": "Does X behave [manner] TOWARD Y?"
        }
    ],
    "examples": [
        {"verb": "尊重", "type": "MS", "reason": "Y triggers respect feeling IN X (internal)"},
        {"verb": "热情", "type": "DISP", "reason": "X behaves warmly TOWARD Y (observable)"},
        {"verb": "信任", "type": "MS", "reason": "Y triggers trust IN X (internal state)"},
        {"verb": "客气", "type": "DISP", "reason": "X behaves politely TOWARD Y (observable)"},
        {"verb": "害怕", "type": "MS", "reason": "Y triggers fear IN X (internal emotion)"},
        {"verb": "冷淡", "type": "DISP", "reason": "X behaves coldly TOWARD Y (observable manner)"},
        {"verb": "讨厌", "type": "MS", "reason": "Y triggers dislike IN X (internal feeling)"},
        {"verb": "言听计从", "type": "DISP", "reason": "X behaves obediently TOWARD Y (observable)"}
    ],
    "test_sentences": [
        ("他对老板很尊重。", "MS", "Y (老板) triggers respect feeling IN X - internal"),
        ("她对客人很热情。", "DISP", "X behaves warmly TOWARD Y - observable manner"),
        ("我对这件事很担心。", "MS", "Y triggers worry IN X - internal state"),
        ("他对下属很严厉。", "DISP", "X behaves strictly TOWARD Y - observable manner"),
        ("她对他充满信任。", "MS", "Y triggers trust state IN X - internal"),
    ]
}

SI_VS_DA_DISTINCTION = {
    "title": "SI vs DA: Intervention vs Direction",
    "key_question": "Can the verb take 他 as direct object? (V他✓ or V他✗)",
    "comparison": [
        {
            "feature": "V他 test",
            "SI": "V他✓ (帮助他✓, 保护他✓)",
        ...
        {
            "feature": "Y's role",
            "SI": "Scope/Patient (affected)",
            "DA": "Recipient (receives action)"
        },
        {
            "feature": "Y affected?",
            "SI": "Yes - undergoes change",
            "DA": "No - receives but not transformed"
        },
        {
            "feature": "对's meaning",
            "SI": "upon / on / over (domain)",
            "DA": "toward / to (direction)"
        },
        {
            "feature": "Typical context",
            "SI": "Institutional, procedural, policy",
            "DA": "Speech acts, gestures, display"
        }
    ],
    "examples": [
        {"verb": "帮助", "type": "SI", "reason": "帮助他✓ - Y is affected by the help"},
        {"verb": "说", "type": "DA", "reason": "说他✗ - speech directed TO Y, Y just receives"},
        {"verb": "保护", "type": "SI", "reason": "保护他✓ - Y is affected (被保护)"},
        {"verb": "笑", "type": "DA", "reason": "笑他✗ - gesture directed AT Y"},
        {"verb": "原谅", "type": "SI", "reason": "原谅他✓ - bounded act, Y's status changes"},
        {"verb": "解释", "type": "DA", "reason": "解释他✗ - explanation directed TO Y"},
        {"verb": "进行调查", "type": "SI", "reason": "Procedural intervention ON scope"},
        {"verb": "点头", "type": "DA", "reason": "点头他✗ - gesture directed AT Y"}
    ],
    "test_sentences": [
        ("我们要对他进行帮助。", "SI", "帮助他✓ - Y is affected by intervention"),
        ("她对他笑了笑。", "DA", "笑他✗ - gesture directed AT Y, not transforming Y"),
        ("政府对企业采取措施。", "SI", "Procedural intervention ON bounded scope"),
        ("老师对学生说道。", "DA", "说他✗ - speech act directed TO Y"),
        ("法院对案件进行审理。", "SI", "审理 is procedural intervention ON scope"),
    ]
}

ABT_VS_SI_DISTINCTION = {
    "title": "ABT vs SI: Topic vs Affected Scope",
    "key_question": "Does Y CHANGE or is Y just the TOPIC of discourse?",
    "comparison": [
        {
            "feature": "Y affected?",
            "ABT": "No - Y is just the topic",
            "SI": "Yes - Y undergoes change"
        },
        {
            "feature": "Y's role",
            "ABT": "Topic/Theme (unaffected)",
            "SI": "Scope/Patient (affected)"
        },
        {
            "feature": "X's action",
            "ABT": "Produces discourse ABOUT Y",
            "SI": "Intervenes ON/UPON Y"
        },
        {
            "feature": "Verb type",
            "ABT": "Discourse verbs (评价, 分析, 讨论)",
            "SI": "Intervention verbs (处理, 帮助, 检查)"
        },
        {
            "feature": "Output",
            "ABT": "Words, analysis, commentary",
            "SI": "Change in Y's state/condition"
        }
    ],
    "examples": [
        {"verb": "分析", "type": "ABT", "reason": "X produces analysis ABOUT Y - Y unchanged"},
        {"verb": "处理", "type": "SI", "reason": "X intervenes ON Y - Y is affected (被处理)"},
        {"verb": "讨论", "type": "ABT", "reason": "X produces discussion ABOUT Y - Y just topic"},
        {"verb": "帮助", "type": "SI", "reason": "X intervenes ON Y - Y is affected (被帮助)"},
        {"verb": "研究", "type": "ABT", "reason": "X produces research ABOUT Y - Y is topic"},
        {"verb": "检查", "type": "SI", "reason": "X intervenes ON Y - Y is examined (被检查)"},
        {"verb": "评价", "type": "ABT", "reason": "X produces evaluation ABOUT Y - discourse"},
        {"verb": "保护", "type": "SI", "reason": "X intervenes ON Y - Y is affected (被保护)"}
    ],
    "test_sentences": [
        ("专家对问题进行分析。", "ABT", "X produces analysis ABOUT Y - Y is topic"),
        ("政府对问题进行处理。", "SI", "X intervenes ON Y - Y is affected"),
        ("学者对现象展开研究。", "ABT", "X produces research ABOUT Y - discourse output"),
        ("警方对嫌疑人采取措施。", "SI", "X intervenes ON Y - Y is affected by measures"),
        ("媒体对事件进行报道。", "ABT", "X produces reporting ABOUT Y - Y is topic"),
    ]
}
...
3. Is it observable BEHAVIOUR/MANNER toward Y?
   │
   ├─ YES (热情, 冷淡, 客气, 像) → DISP
   │
   └─ NO ↓
